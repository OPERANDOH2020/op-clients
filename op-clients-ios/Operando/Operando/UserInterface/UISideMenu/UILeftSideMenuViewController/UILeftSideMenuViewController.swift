...
//        self.sideMenuViewController?.contentViewController = UINavigationManager.profileNavigationViewController
    ...
    public func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let numOfNotificationsRequest: NumOfNotificationsRequestCallback? = indexPath.row == dataSource.count - 2 ? self.callbacks?.dashboardCallbacks?.numOfNotificationsRequestCallback : nil
