...
public extension String {
    ...
    public static func fontAwesomeEnum(forIconIdentifier string: String) -> FAIcon {
    ...
    public static func fontAwesomeIconStringForIconIdentifier(identifier: String) -> String {
        return fontAwesomeIconStringForEnum(value: fontAwesomeEnum(forIconIdentifier: identifier))
    }
}
